        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="/APanel"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/pages/merchant.jsp"><i class="fa fa-cc"></i> Manage Merchants</a>
                    </li>
                    <li>
                        <a href="/pages/manage_services.jsp"><i class="fa fa-cogs"></i> Manage Services</a>
                    </li>
                    <li>
                        <a href="/pages/manage_users.jsp"><i class="fa fa-users"></i> Manage Users</a>
                    </li>
                    <li>
                        <a href="/pages/services.jsp"><i class="fa fa-cog"></i> Services</a>
                    </li>
